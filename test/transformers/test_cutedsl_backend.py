"""Verify LIGER_KERNEL_IMPL=cutedsl routes RMSNorm ops and transformers to cuTeDSL implementations."""
...
# Transformer modules bind liger_kernel.ops.* at import time.
TRANSFORMER_MODULES = {
